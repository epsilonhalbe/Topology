...
\hspace*{8cm}\includegraphics[scale=1]{./pic/umgeb}\vspace*{-4cm}\\
...
\end{array}\right.$\\
\begin{center}
\includegraphics[scale=0.7]{./pic/unstet1}
\includegraphics[scale=0.7]{./pic/unstet2}
\end{center}
$f([-1,+1])=[-1,0]\cup [1,2)$\\
...
\begin{center}
\includegraphics[scale=0.8]{./pic/topoweg}
\end{center}
...
\vspace*{-1.5cm}\item[(UB2)] $\forall W_1,W_2\in\umgbas{W}{x}\exists W_3\seq W_1\cap W_2$\footnote{(UB1) und (UB2) sind auch die Grundeigenschaften(FB1) und (FB2) einer \ul{Filterbasis}}\includegraphics[scale=0.7]{./pic/umgbas}\\
...
\includegraphics[scale=0.8]{./pic/ub4}\vspace*{-4.1cm}\\
...
\vspace*{-5.5cm}\\ \hspace*{9cm}\includegraphics[scale=0.7]{./pic/niemytzkiright}\\
...
\hspace*{9.5cm}\includegraphics[scale=0.5]{./pic/subbasis}\vspace*{-5cm}\\
Ist I endlich:\\
...
\hspace*{10cm}\includegraphics[scale=0.4]{./pic/AAc}\vspace*{-2.7cm}\\
...
\end{lemma}
\includegraphics[scale=0.6]{./pic/2-45}
...
\includegraphics{./pic/niemytzkiright}
...
\hspace*{4.5cm}\includegraphics{./pic/uryreal}\\
...
\hspace*{-1cm}\includegraphics[scale=0.9]{./pic/urysohn}
\newpage
...
\hspace*{8cm}\includegraphics[scale=1.5]{./pic/5-2ii}
...
\vspace*{-3cm}\\
\hspace*{7cm}\includegraphics{./pic/5-3-4}\vspace*{-2.5cm}\\
\end{enumerate}
\end{beispiel}
...
\hspace*{6cm}\includegraphics[scale=0.8]{./pic/5-5}\\
...
Veranschaulichung:\\
\includegraphics{./pic/einbettung}\\
...
Veranschaulichung\\
\includegraphics{./pic/projection}\\
...
\hspace*{5.5cm}\includegraphics[scale=0.7]{./pic/pr}\\
\includegraphics{./pic/projektionsabb}\\
...
\includegraphics[scale=0.8]{./pic/kompaktheitsbegriffe}
\end{beob}
...
\includegraphics{./pic/alexandroff}\\
...
\includegraphics[scale=0.82]{./pic/zshg}\\
...
\end{enumerate}
\includegraphics{./pic/vervollstandigung}
\end{definition}
